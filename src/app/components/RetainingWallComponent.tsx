      ...
      <div className="max-w-[1800px] mx-auto">
        ...
        <div className="flex flex-col md:flex-row justify-between items-end mb-16 gap-6 border-b border-slate-200 pb-12">
          <div className="space-y-2">
            <p className="text-5xl md:text-7xl font-black text-[#b72121] tracking-tighter uppercase">
              Retaining <span style={{ WebkitTextStroke: "1px #b72121", color: "transparent" }}>Walls.</span>
            </p>
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
          {wallSystems.map((wall, idx) => (
            ...
            >
              ...
              <div className="hidden md:flex items-center justify-center w-16 bg-[#b72121] text-white/20 select-none">
              ...
              <div className="flex-1 p-10 md:p-14 relative">
                ...
                <div className="flex justify-between items-start mb-10">
                  <div className="p-4 bg-slate-50 text-[#b72121]/80 group-hover:bg-[#b72121]/80 group-hover:text-white transition-colors duration-500">
                    {wall.icon}
                  </div>
                </div>

                <h3 className="text-4xl font-black text-[#b72121] uppercase tracking-tighter mb-6 group-hover:text-[#b72121]/80 transition-colors">
                  {wall.title}
                </h3>
                ...
                <div className="grid grid-cols-3 gap-4 border-t border-slate-100 pt-8 mb-8">
                  {wall.specs.map((spec, i) => (
                    <div key={i} className="space-y-1">
                      <div className="h-1 w-4 bg-[#b72121]/80/20 group-hover:w-full transition-all duration-700" />
                      <p className="text-[9px] font-mono font-black text-slate-400 uppercase tracking-tighter">
                        {spec.split(":")[0]}
                      </p>
                      <p className="text-[11px] font-bold text-[#b72121]">
                        {spec.split(":")[1]}
                      </p>
                    </div>
                  ))}
                ...
                {/* Footer Action */}
                <button className="flex items-center gap-3 text-[10px] font-black uppercase tracking-[0.3em] text-[#b72121]/80 group-hover:gap-6 transition-all duration-500">
              ...
              <div className="absolute top-0 right-0 p-4 opacity-[0.03] group-hover:opacity-10 transition-opacity">
                <Maximize2 className="w-20 h-20 text-[#b72121]" />
              </div>
            </motion.div>
          ))}
        </div>
