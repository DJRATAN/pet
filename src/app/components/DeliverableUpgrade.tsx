...
export default function DeliverableUpgrade() {
  return (
    <section className="relative w-full bg-[#b72121] text-white overflow-hidden">
      ...
      <div className="absolute top-0 right-0 w-[800px] h-[800px] bg-[#b72121]/80 rounded-full blur-[200px] opacity-30 pointer-events-none" />
      ...
      <div className="w-full px-10 md:px-20 py-8 relative z-10 mx-auto">
        ...
        <div className="max-w-5xl mb-8 space-y-6">
          ...
          <p className="text-xl md:text-2xl text-white/80 font-medium max-w-3xl leading-relaxed mt-2 border-l-4 border-[#b72121]/80 pl-6">
          ...
          {upgradeFeatures.map((feature, idx) => (
            ...
            >
              ...
              <div className="flex justify-between items-start mb-8 relative z-10">
                ...
                <div className="p-5 bg-[#b72121] text-white group-hover:bg-white group-hover:text-[#b72121]/80 transition-all duration-500 group-hover:-translate-y-2 group-hover:rotate-6 group-hover:shadow-[0_10px_20px_rgba(0,0,0,0.15)]">
                  {feature.icon}
                </div>
              </div>
              ...
              <div className="relative z-10 flex-grow">
                ...
                <p className="text-[#b72121]/80 group-hover:text-white font-black text-[10px] uppercase tracking-widest mb-3 transition-colors duration-500">
                  {feature.subtitle}
                </p>
                {/* Title: Dark Blue -> Hovers to White */}
                <h3 className="text-[#b72121] group-hover:text-white text-3xl font-black uppercase tracking-tighter mb-3 leading-none transition-colors duration-500">
                  {feature.title}
                </h3>
                {/* Description: Dark Blue faded -> Hovers to White faded */}
                <p className="text-[#b72121]/80 group-hover:text-white/90 text-sm leading-relaxed font-medium transition-colors duration-500">
                  {feature.description}
                </p>
              </div>
              ...
              <div className="mt-4 pt-4 border-t border-[#b72121]/80 group-hover:border-white/30 flex justify-between items-center relative z-10 transition-colors duration-500">
                <span className="text-[10px] font-black uppercase tracking-[0.2em] text-[#b72121] group-hover:text-white opacity-0 group-hover:opacity-100 transition-all duration-500">
                  Initialize Upgrade
                </span>
              ...
              <div className="absolute -bottom-10 -right-10 opacity-[0.03] group-hover:opacity-10 transition-opacity duration-700 pointer-events-none">
                <div className="scale-[4] text-[#b72121] group-hover:text-white transition-colors duration-500">
                  {feature.icon}
                </div>
              </div>
