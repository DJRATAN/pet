    ...
    <section ref={targetRef} className="relative h-[300vh] bg-white">
      ...
      <div className="sticky top-0 flex h-screen items-center overflow-hidden max-w-[1600px] mx-auto px-10 md:px-20">
        ...
        <div className="absolute top-24 left-10 md:left-20 pointer-events-none select-none">
            <h2 className="text-[10vw] font-black text-[#b72121] opacity-[0.03] leading-none uppercase">
                Miles & Miles
            </h2>
        </div>
        ...
        <motion.div style={{ x }} className="flex gap-8 items-center relative z-10">
          ...
          <div className="flex h-[400px] w-[450px] shrink-0 flex-col justify-center p-12 bg-[#b72121] text-white relative shadow-xl">
            <div className="absolute top-0 left-0 w-2 h-full bg-[#b72121]/80" />
            <Waypoints className="w-10 h-10 text-[#b72121]/80 mb-6" />
            ...
            <div className="flex items-center gap-3 text-white font-black text-[10px] uppercase tracking-widest bg-[#b72121]/80 px-6 py-4 self-start shadow-lg">
          ...
          {trenchData.map((item) => (
            <motion.div
              ...
              className={`group relative h-[400px] w-[350px] shrink-0 border transition-all duration-500 overflow-hidden
                ${item.isPrimary 
                  ? 'bg-[#b72121]/80 border-[#b72121]/80 text-white shadow-[0_20px_50px_rgba(27,121,238,0.3)]' 
                  : 'bg-white border-[#b72121]/80 text-[#b72121] hover:border-[#b72121]/80 hover:shadow-[0_20px_50px_rgba(0,74,173,0.1)]'
                }`}
            >
              {/* IMAGE CONTAINER */}
              <div className={`relative h-48 w-full flex items-center justify-center p-8 transition-colors duration-500
                ${item.isPrimary ? 'bg-white/10' : 'bg-[#b72121]/5 group-hover:bg-[#b72121]/80/5'}
              `}>
                ...
                {/* ID Tag */}
                <div className="absolute top-4 left-4 bg-white px-2 py-0.5 border border-[#b72121]/80">
                   <span className="text-[8px] font-black text-[#b72121] uppercase tracking-widest">{item.id}</span>
                </div>
              </div>
              ...
              <div className="p-8 flex flex-col flex-grow">
                <h4 className={`text-2xl font-black uppercase tracking-tighter leading-tight mb-2
                  ${item.isPrimary ? 'text-white' : 'text-[#b72121]'}
                `}>
                    {item.title}
                </h4>
                <p className={`text-[10px] font-black uppercase tracking-tight mb-4
                  ${item.isPrimary ? 'text-white/80' : 'text-[#b72121]/70'}
                `}>
                    {item.tagline}
                </p>
                ...
                <div className={`mt-auto pt-6 border-t flex justify-between items-center
                  ${item.isPrimary ? 'border-white/20' : 'border-[#b72121]/5'}
                `}>
                  ...
                  <Shield className={`w-4 h-4 ${item.isPrimary ? 'text-white/40' : 'text-[#b72121]/80'}`} />
                </div>
              </div>

              {/* Interaction Top Accent for White Cards */}
              {!item.isPrimary && (
                <div className="absolute top-0 left-0 w-0 h-1 bg-[#b72121]/80 group-hover:w-full transition-all duration-700" />
              )}
            </motion.div>
          ))}

          {/* FINAL ACTION BLOCK */}
          <div className="flex h-[400px] w-[400px] shrink-0 flex-col items-center justify-center p-10 bg-white border-2 border-dashed border-[#b72121]/80 relative">
             <Zap className="w-12 h-12 text-[#b72121]/80 mb-6 animate-pulse" />
             <h3 className="text-3xl font-black text-[#b72121] text-center uppercase tracking-tighter leading-none mb-4">
                Scalable <br /> Systems.
             </h3>
             <p className="text-[#b72121]/60 text-center text-[10px] font-black mb-8 max-w-xs uppercase tracking-tighter">
                Seamlessly integrated from desk to shop floor.
             </p>
             <button className="bg-[#b72121] hover:bg-[#b72121]/80 text-white px-10 py-4 text-[10px] font-black uppercase tracking-widest transition-all shadow-xl">
                Initiate Protocol
             </button>
          </div>
