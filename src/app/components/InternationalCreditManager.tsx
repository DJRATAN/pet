  ...
  return (
    <div className="w-full max-w-4xl mx-auto p-6 space-y-6 bg-slate-50">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 border-b border-slate-200 pb-6">
        <div>
          <h2 className="text-2xl font-bold text-[#b72121]">Global Communication Credits</h2>
          <p className="text-slate-500 text-sm font-medium uppercase tracking-tight">Mega Foundries US | Project ID: 2026-MF</p>
        </div>
        <Badge variant="outline" className="bg-[#b72121]/80/10 text-[#b72121]/80 border-[#b72121]/80 px-4 py-1 text-sm font-bold">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        {/* Quick Top-Up Card */}
        <Card className="border-2 border-[#b72121] shadow-[4px_4px_0px_rgba(0,74,173,0.1)] rounded-none">
          <CardHeader className="bg-[#b72121] text-white">
          ...
          <CardContent className="pt-6 space-y-4">
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <Input defaultValue="30" className="pl-8 border-slate-200 focus-visible:ring-[#b72121]/80" />
              </div>
            </div>
            <Button className="w-full bg-[#b72121]/80 hover:bg-[#b72121] text-white font-bold rounded-none uppercase tracking-widest text-xs">
              Add GIO Credit
            </Button>
          </CardContent>
        </Card>
        ...
        <Card className="border border-slate-200 rounded-none hover:border-[#b72121]/80 transition-all">
          <CardHeader>
            <CardTitle className="flex items-center gap-2 text-[#b72121] text-lg">
              <Globe className="w-5 h-5" /> Int'l Calling
            </CardTitle>
            <CardDescription>Direct Project Outreach</CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            <div className="p-3 bg-slate-100 border-l-4 border-[#b72121]/80">
            ...
            <Button variant="outline" className="w-full border-[#b72121] text-[#b72121] hover:bg-slate-50 font-bold rounded-none uppercase text-xs">
              Activate One HR
            </Button>
          </CardContent>
        </Card>
        ...
        <Card className="border border-slate-200 rounded-none bg-[#b72121] text-white">
          <CardContent className="pt-8 flex flex-col items-center text-center">
            <PhoneCall className="w-10 h-10 mb-4 opacity-50 text-[#b72121]/80" />
      ...
      <div className="bg-white border border-slate-200 p-6 rounded-none">
        <div className="flex items-center gap-2 mb-4 text-[#b72121] font-bold">
        ...
        <table className="w-full text-left">
          ...
          <tbody className="divide-y divide-slate-100">
            <tr className="text-xs">
              ...
              <td className="py-4 px-4 font-bold text-[#b72121]">₹30.00</td>
            ...
            <tr className="text-xs">
              ...
              <td className="py-4 px-4 font-bold text-[#b72121]">₹---</td>
