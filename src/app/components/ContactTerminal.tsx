...
export default function ContactTerminal() {
  ...
  return (
    <section className="w-full py-32 bg-[#b72121] text-white overflow-hidden relative">
      ...
      <div className="w-full px-10 md:px-20  relative z-10">
        ...
        <div className="flex flex-col md:flex-row justify-between items-end mb-20 gap-10">
          <div className="space-y-4 max-w-4xl">
            <div className="flex items-center gap-3 text-[#b72121]/80 font-mono text-[10px] font-black uppercase tracking-[0.5em]">
        ...
        <div className="grid grid-cols-1 xl:grid-cols-12 gap-16 items-start">
          ...
          <div className="xl:col-span-5 space-y-12">
            ...
            <div>
              <div className="flex items-center gap-3 border-b border-white/20 pb-4 mb-6">
                <Globe className="w-5 h-5 text-[#b72121]/80" />
              ...
              <div className="space-y-4">
                {globalNodes.usa.map((node, idx) => (
                  <motion.div 
                    ...
                    className="group flex gap-6 p-5 bg-white/5 border border-white/10 hover:border-[#b72121]/80 hover:bg-white/10 transition-all duration-300"
                  >
                    <div className="flex flex-col items-center gap-2 mt-1">
                      <div className="w-2 h-2 rounded-full bg-[#b72121]/80 group-hover:animate-ping absolute" />
                      <div className="w-2 h-2 rounded-full bg-[#b72121]/80 relative z-10" />
                      <div className="w-px h-full bg-white/20 group-hover:bg-[#b72121]/80/50 transition-colors" />
                    </div>
                    <div className="flex-1 space-y-3">
                      <h4 className="text-lg font-black uppercase tracking-tighter text-white group-hover:text-[#b72121]/80 transition-colors">
                        {node.region} Node
                      </h4>
                      <div className="space-y-1.5">
                        <p className="font-mono text-[10px] text-white/70 flex items-center gap-2 uppercase tracking-wider">
                          <MapPin className="w-3 h-3 text-[#b72121]/80" /> {node.address}, {node.city}
                        </p>
                        <p className="font-mono text-[10px] text-white/70 flex items-center gap-2 uppercase tracking-wider">
                          <Phone className="w-3 h-3 text-[#b72121]/80" /> {node.phone}
                        </p>
                      </div>
                    </div>
                  </motion.div>
            ...
            <div>
              ...
              <div className="space-y-4">
                {globalNodes.international.map((node, idx) => (
                  ...
                  >
                    <div className="flex flex-col items-center gap-2 mt-1">
                      <div className="w-2 h-2 rounded-full bg-[#b72121]/80 relative z-10 group-hover:bg-[#b72121]/80 transition-colors" />
                      <div className="w-px h-full bg-white/20 group-hover:bg-[#b72121]/80/50 transition-colors" />
                    </div>
                    <div className="flex-1 space-y-3">
                      <h4 className="text-lg font-black uppercase tracking-tighter text-white group-hover:text-[#b72121]/80 transition-colors">
          ...
          >
            ...
            <div className="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-[#b72121]/80 to-[#b72121]/80" />
            <div className="absolute -top-3 -right-3 w-6 h-6 border-t-2 border-r-2 border-[#b72121]/80" />
            <div className="absolute -bottom-3 -left-3 w-6 h-6 border-b-2 border-l-2 border-[#b72121]/80" />
            ...
            <form onSubmit={handleSubmit} className="space-y-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div className="space-y-2">
                  <label className="font-mono text-[10px] uppercase tracking-widest text-[#b72121]/80 flex items-center gap-2">
                  ...
                  <input 
                    ...
                    className="w-full bg-white/5 border-b-2 border-white/20 px-4 py-3 text-white placeholder:text-white/30 focus:outline-none focus:border-[#b72121]/80 focus:bg-white/10 transition-all font-medium"
                  />
                </div>
                <div className="space-y-2">
                  <label className="font-mono text-[10px] uppercase tracking-widest text-[#b72121]/80 flex items-center gap-2">
              ...
              <div className="space-y-2">
                ...
                <select 
                  ...
                  className="w-full bg-white/5 border-b-2 border-white/20 px-4 py-3 text-white focus:outline-none focus:border-[#b72121]/80 focus:bg-white/10 transition-all font-medium appearance-none cursor-pointer"
                >
                  <option value="" className="bg-[#b72121] text-white">Select Primary Inquiry...</option>
                  <option value="engineering" className="bg-[#b72121] text-white">Engineering & Drawings</option>
                  <option value="manufacturing" className="bg-[#b72121] text-white">Manufacturing Capabilities</option>
                  <option value="consulting" className="bg-[#b72121] text-white">Governmental Consulting</option>
                  <option value="other" className="bg-[#b72121] text-white">General Information / Other</option>
                </select>
              </div>
              ...
              <div className="space-y-2">
                ...
                <textarea 
                  ...
                  className="w-full bg-white/5 border-b-2 border-white/20 px-4 py-3 text-white placeholder:text-white/30 focus:outline-none focus:border-[#b72121]/80 focus:bg-white/10 transition-all font-medium resize-none"
                />
              </div>
              ...
              <button 
                type="submit"
                className="w-full group relative bg-white text-[#b72121] py-5 flex items-center justify-center gap-3 overflow-hidden transition-all shadow-[0_0_20px_rgba(255,255,255,0.1)] hover:shadow-[0_0_40px_rgba(103,232,249,0.3)]"
              >
                {/* Button Hover Fill */}
                <div className="absolute inset-0 bg-[#b72121]/80 translate-y-full group-hover:translate-y-0 transition-transform duration-500 ease-in-out z-0" />
