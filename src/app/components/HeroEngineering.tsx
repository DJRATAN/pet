    ...
    <section className="relative w-full pt-36 pb-24 flex flex-col items-center justify-center border-b bg-white overflow-hidden">
      ...
      <div className="container px-4 md:px-6 flex flex-col items-center text-center space-y-10 z-10">
        ...
        >
          ...
          {/* THE NEW HEADLINE */}
          <h1 className="text-5xl md:text-8xl font-black tracking-tighter text-[#b72121] leading-[0.9] uppercase">
            THE FUTURE OF <br />
            <span style={{ WebkitTextStroke: "1.5px #b72121", color: "transparent" }}>PRECAST ENGINEERING.</span>
          </h1>
          ...
          >
            "From conception to execution, the Futuristic highway of  <span className="text-[#b72121] font-bold">Precast Engineering</span>, <span className="text-[#b72121] font-bold">Advanced Technologies</span> & beyond."
          </motion.p>
        </motion.div>
        ...
        <motion.div 
          ...
          className="w-full max-w-4xl flex items-center gap-0 bg-white border-[3px] border-[#b72121] rounded-none overflow-hidden shadow-[20px_20px_0px_-5px_rgba(0,74,173,0.05)]"
        >
          <div className="pl-6">
            <Search className="w-7 h-7 text-[#b72121]/80" />
          </div>
          <Input
            type="text"
          ...
          />
          <Button className="rounded-none h-20 px-12 bg-[#b72121] hover:bg-[#b72121]/80 text-white font-black transition-all text-xl tracking-widest">
            INITIALIZE SEARCH
          </Button>
        </motion.div>
        ...
        <div className="flex flex-wrap justify-center gap-x-8 gap-y-2 text-[10px] font-black text-slate-400 uppercase tracking-[0.2em]">
          <span className="hover:text-[#b72121]/80 cursor-pointer transition-colors">Popular_Nodes:</span>
          <span className="hover:text-[#b72121] cursor-pointer transition-colors text-slate-300">Wall Panels</span>
          <span className="hover:text-[#b72121] cursor-pointer transition-colors text-slate-300">Hollow-Core Slabs</span>
          <span className="hover:text-[#b72121] cursor-pointer transition-colors text-slate-300">Bridge Girders</span>
          <span className="hover:text-[#b72121] cursor-pointer transition-colors text-slate-300">Culvert Systems</span>
        </div>
